...
const Contact: FC = () => {
  ...
  return (
    <Page>
      <section className=" text-white dark:bg-gray-800 dark:text-gray-100">
        <div className="container flex flex-col items-center justify-center py-4 mx-auto sm:p-5">
          <p className="p-2 text-sm font-medium tracking-wider text-center uppercase">
            Development team
          </p>
          <h1 className="text-4xl font-bold leading-none text-center sm:text-5xl mb-10">
            The talented people behind the scenes
          </h1>
          <div className="flex flex-row flex-wrap justify-center mt-8">
            <div className="flex flex-col justify-center w-full px-8 mx-4 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
              <img
                alt=""
